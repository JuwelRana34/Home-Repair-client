  ...
  return (
    <div className="min-h-screen">
      <h1 className="text-3xl font-bold text-center my-5 py-4">
        About the service{" "}
        <span className="text-gray-900 dark:text-metal-300">
          &quot;{Details.Service_Name}&quot;{" "}
        </span>
      </h1>
      <Card className=" md:flex md:p-4 my-1 gap-5 items-start md:max-w-[90%]  mx-auto dark:bg-metal-800 dark:border-metal-800  rounded-md shadow-md">
        <CardHeader className="md:w-[50%] md:h-[440px]">
          <img
        ...
        <CardContent className=" md:w-[50%] space-y-5 p-4 flex-col gap-5">
          <div className="space-y-2">
            <CardTitle className="dark:text-metal-300 text-3xl font-bold capitalize">
              Service info:{" "}
            </CardTitle>
            ...
            <p className=" capitalize py-2 font-semibold text-lg">
              {" "}
              price: $ {Details?.price}
            </p>
            ...
            <Button
              ...
              className="bg-blue-500 dark:bg-metal-700 dark:text-gray-300"
            >
              Book Now
            </Button>
          </div>
          ...
          <div className=" flex-col justify-end">
            ...
            <p className=" mt-2 flex items-center gap-1 capitalize font-semibold text-md">
              {" "}
              <IoLocationSharp /> Service area: {Details?.Service_Area}{" "}
            </p>
          </div>
        </CardContent>
      </Card>
