...
function Not_found() {
  ...
  return ( 
        <Empty>
          <EmptyImage>
            <img className=' w-full lg:w-[80%] mx-auto rounded-md' src="https://img.freepik.com/free-vector/404-error-with-man-thinking_24908-77772.jpg?ga=GA1.1.1974322130.1689523785&semt=ais_hybrid" alt="" />
          </EmptyImage>
